...
export function parseCodeowners(content: string, teamPrefix: string): CodeownersRule[] {
  ...
  for (const line of content.split('\n')) {
    ...
    const team = owners.map(owner => teamFor(owner, teamPrefix)).find(slug => slug !== null)
